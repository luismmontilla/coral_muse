...
ggplot(coral_summ, aes(x = se, 
  ...
  annotate("text", label = paste("Pearson's correlation =", 
                                 round(cor(coral_summ$mse, coral_summ$se), 3)), 
           x = 4.3, y = 0.25)

ggplot(coral_summ, aes(x = richness, 
             y = mse, 
             label = sites,
             color = Locality,
             size = 2)) +
  ...
  theme(legend.position="bottom") +
  annotate("text", label = paste("Pearson's correlation =", 
                                 round(cor(coral_summ$mse, coral_summ$richness), 3)), 
           x = 12, y = 0.25)
