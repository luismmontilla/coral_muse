...
ggplot(field_mse, aes(x = fct_rev(sites), 
  ...
  #ggsave('analysis/figures/fig01.png', height = 7.45)
```
...
```{r fig02}
field_mse[,c('mse', 'sites', 'Locality')] %>% 
  ...
  annotate("text", label = "Pearson's correlation = 0.14", 
           x = 4.3, y = 0.25)

#ggsave('analysis/figures/fig02b.png')
```
...
plot_coefs(bc_mod$trafo_mod, colors = 'black', scale = TRUE) +
  ...
  geom_rect(xmin = -Inf, xmax = Inf,   ymin = 4.6, ymax = 7.4,  
            fill = "gray", alpha = 0.05) +
  labs(y = 'Term')
#ggsave('analysis/figures/fig03.png')
```
