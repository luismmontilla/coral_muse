randomchoose25 <- function(x, randomseed = 1) {
  Transecta <- x
  ...
  for(i in 1:length(Transectasplit)) {
    ...
    Transecta25 <- rbind(Transecta25, Transecta100[sample(1:100, 25), ]) #En el caso nuevo esta linea cambia y condiciona el numero de puntos
    Transecta100 <- Transectasplit[[1]][0, ]
  }
